...
| Confirm button | 32 | INPUT_PULLUP; ยืนยันว่าทานเองแล้ว / สั่ง sync ใหม่ |
| Dispense button | 33 | INPUT_PULLUP; สั่งจ่ายยามื้อที่กำลังเตือน |
| Cancel button | 27 | INPUT_PULLUP; กดสั้น = ข้ามมื้อ, กดค้าง ≥1.2 วินาที = หยุดกลไก |
