...
{
  Serial.print("Lane 1 dispense amount: ");
  Serial.println(amount);

  // TODO: calibrate servo angles and implement IR-confirmed pill counting.
  // TODO: generate the required 38 kHz signal for each IR transmitter module.
}
